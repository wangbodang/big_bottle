package com.vefuture.big_bottle.common.util.security;


import com.vefuture.big_bottle.common.constants.Constants;
import com.vefuture.big_bottle.common.constants.HttpStatus;
...
*/
    ...
    {
        List<RoleEntity> roleList = getLoginUser().getUser().getRoles();
        Collection<String> roles = roleList.stream().map(RoleEntity::getRoleName).collect(Collectors.toSet());
